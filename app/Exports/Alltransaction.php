...
class Alltransaction implements FromQuery,WithHeadings
{
    /**
    ...
    */
    ...
    public function query()
    {
        ...
        $bulk = Alltransition::query()->select('date','time','amt','bal','r')->where('uid',session()->get('userid'));
         return $bulk;
    }
