...
class Payouttransactionexport implements FromQuery,WithHeadings
{
     /**
    ...
    */
    ...
    public function query()
    {
        ...
        $bulk = PayoutModel::query()->select('date','amount','transferid','uti','account_no','ifsc')->where('uid',session()->get('userid'));
         return $bulk;
    }
