 ...
 <body onload="submitPayuForm()">
   Processing.....
       <form action="<?php echo $action; ?>" method="post" name="payuForm"><br />
           <input type="hidden" name="key" value="<?php echo $appId ?>" /><br />
           ...
           <input type="hidden" name="firstname" id="firstname" value="Amit majuder" /><br />
           <input type="hidden" name="email" id="email" value="amitmajumder559@gmail.com" /><br />
