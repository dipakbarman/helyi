...
<div class="row">
    <div class="col-md-12 card p-1">
        <form action="{{ url('total_business_filter') }}" method="get">
            @csrf
        <div class="row mb-2">
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                <label for=""> </label>
                <a href="{{ url('total_business') }}" type="submit" class="btn btn-success btn-block">Reset</a>
            </div>
        </div>
    </form>
</div>
                    ...
                    <thead>
                      ...
                      <tbody>
                              ...
                              <tr>
                                  ...
                                  <td id="total_css">{{number_format($wallet_added_total,0)}}</td>
                              </tr>
                      </tbody>
                </table>
                <div class="py-2">
                    ...
                    <thead>
                      ...
                      <tbody>
                              ...
                              <tr>
                                  ...
                                  <td></td>
                                  <td id="total_css">Total</td>
                                  <td id="total_css">{{number_format($total_payout_done_total,0)}}</td>
                              </tr>
                      </tbody>
                </table>
                <div class="py-2">
