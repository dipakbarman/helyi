    ...
    <div class="col-md-12">
        <div class="card p-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form action="{{ url('update_payment_option') }}" method="post" onsubmit="validbtn()">
                        @csrf
                        <div class="mb-2">
                        ...
                        <div class="p-1">
                            ...
                            @if(check_alredy_option_exist($getway_id,$item->id) == 1)
                                disabled 
                             @else
                             @if(check_active_getway_option($getway_id,$item->id) == 1)
                              checked 
                             @endif
                             @endif
                             />
